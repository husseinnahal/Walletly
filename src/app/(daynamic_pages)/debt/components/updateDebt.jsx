...
export default function UpdateDebt({ visible, onClose , info ,updated}) {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://walletlyapi.onrender.com/api/debts/${info._id}`,
        values,
        {
          headers: {
      ...
      updated()
      toast.current.show({ severity: "success", summary: "Success", detail: t("Debt.upSuccess") });
  ...
  return (
    <Dialog visible={visible} onHide={onClose} header={t("Debt.upDebt")} maximizable className="dialog">
      <Toast ref={toast} />
