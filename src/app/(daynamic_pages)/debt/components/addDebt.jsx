...
export default function AddDebt({ visible, onClose ,onAdd}) {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://walletlyapi.onrender.com/api/debts",
        values,
        {
          headers: {
      ...
      toast.current.show({ severity: "success", summary: "Success", detail: t("Debt.addSuccess") });
      resetForm();
      onAdd()
  ...
  return (
    <Dialog visible={visible} onHide={onClose} header={t("Debt.adddebt")} maximizable className="dialog">
      <Toast ref={toast} />
            ...
            <Form className="formContainer">
              <div>
                <label className="label">
                  {t("Debt.forwhom")} <span className="required">*</span>
                </label>
                <Field name="forWhom" as={InputText} placeholder="for whom" className="input" />
                <ErrorMessage name="forWhom" component="div" className="errorMessage" />
              </div>
              ...
              <div className="buttonContainer">
                <Button label={loading ? `${t("create")}...` : t("create")} type="submit" className="button" disabled={loading} />
              </div>
            </Form>
          )}
        </Formik>
