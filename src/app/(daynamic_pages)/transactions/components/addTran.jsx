...
export default function AddTran({ visible, onClose ,Cats ,onTransactionAdded}) {
...
// add transaction
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      const response=await axios.post(
        "https://walletlyapi.onrender.com/api/transaction",
        values,
        {
          headers: {
      ...
      onTransactionAdded();
      toast.current.show({ severity: "success", summary: "Success", detail: t("AddTran.addTransaction") });
      resetForm();
  ...
  return (
    <Dialog visible={visible} onHide={onClose} header={t("filters.addTransaction")} maximizable className="dialog">
      <Toast ref={toast} />
