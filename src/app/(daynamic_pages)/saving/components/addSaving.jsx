...
export default function AddSaving({ visible, onClose ,onAdd}) {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://walletlyapi.onrender.com/api/goals",
        values,
        {
          headers: {
      ...
      toast.current.show({ severity: "success", summary: "Success", detail: t("savings.addSuccess") });
      resetForm();
      onAdd()
  ...
  return (
    <Dialog visible={visible} onHide={onClose} header={t("savings.addGoal")} maximizable className="dialog">
      <Toast ref={toast} />
