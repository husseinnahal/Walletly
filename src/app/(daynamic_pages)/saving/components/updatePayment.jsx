...
export default function AddPayments({ visible, onClose,goalId,pay,handlePay,handleGoals}) {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://walletlyapi.onrender.com/api/goals/saved-amount/${goalId}/${pay._id}`,
        values,
        {
          headers: {
      ...
      handlePay();
      handleGoals();
      toast.current.show({ severity: "success", summary: "Success", detail: t("savings.payment.upPaySuccess") });
  ...
  return (
    <Dialog visible={visible} onHide={onClose} header={t("savings.payment.upPay")} maximizable className="dialog">
      <Toast ref={toast} />
